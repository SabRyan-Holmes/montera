...
export default function UseAturanPenetapan(aturanPAK, koefisien = []) {
    ...
    useEffect(() => {
        ...
        let defaultPenandaTangan = aturanPAK.penandaTangan.value[defaultConfigPT - 1]; //tambah 1 karna indeks array dimulai dari 0

        // data.nama = 'Agus Sudibyo, M.Stat'
        console.log("defaultPenandaTangan");
        console.log(defaultPenandaTangan);
        setData({
            ...data,
