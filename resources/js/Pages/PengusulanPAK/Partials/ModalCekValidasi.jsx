...
export default function ModalCekValidasi({ pengusulanPAK, setActiveModalId }) {
    ...
    //     if (message) {
    //         Swal.fire({
    //             target: `#DialogCekValidasi-${pengusulanPAK.id}`,
    //             title: "Berhasil!",
    //             text: `${message}`,
    //             icon: "success",
    //             iconColor: "#50C878",
    ...
    const handleCancel = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.post(route("pimpinan.pengusulan-pak.cancel", pengusulanPAK.id), {
                    onSuccess: () => {
                        //
                    },
                    onError: () => {
    ...
    const handleViewPdf = async (pengajuan) => {
        router.post("/pak/process", pengusulanPAK.riwayat_pak, {
            preserveScroll: true,
            preserveState: true,
    ...
    return (
        <dialog
            id={`DialogCekValidasi-${pengusulanPAK.id}`} onClose={()=> setActiveModalId(null)}
        ...
        >
            ...
            <div className="relative w-full max-w-3xl modal-box">
                ...
                <h3 className="mb-2 text-xl font-bold">Detail Pengusulan PAK</h3>
                ...
                <div className="px-2 overflow-x-auto">
                    ...
                    {/* <DetailPAKTable
                        data={pengusulanPAK.riwayat_pak}
                        collapse={false}
                    /> */}
                </div>
