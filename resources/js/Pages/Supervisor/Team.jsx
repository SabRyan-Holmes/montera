    ...
    const openDetail = async (member) => {
        ...
        try {
            ...
            const response = await axios.get(
                route("spv.team.transactions", member.id),
            );
                        ...
                        <div className="flex items-center p-6 bg-white border-l-4 shadow-sm border-primary rounded-xl">
                            ...
                            <div>
                                ...
                                <p className="text-xl font-black text-secondary">
                                    {formatRupiah(
                                        teamStats.total_realisasi_tim,
                                    )}
                                </p>
                                <p className="text-xs text-gray-500">
                                    dari target{" "}
                                    {formatRupiah(teamStats.total_target_tim)}
                                </p>
                            </div>
                        </div>
                                    ...
                                    teamMembers.map((member, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 font-medium">
                                                {index + 1 === 1 ? (
                                                    <span className="flex items-center justify-center w-8 h-8 font-bold text-yellow-700 bg-yellow-100 border border-yellow-300 rounded-full">
                                                        1
                                                    </span>
                                                ) : index + 1 === 2 ? (
                                                    <span className="flex items-center justify-center w-8 h-8 font-bold text-gray-700 bg-gray-200 border border-gray-300 rounded-full">
                                                        2
                                                    </span>
                                                ) : index + 1 === 3 ? (
                                                    <span className="flex items-center justify-center w-8 h-8 font-bold text-orange-800 bg-orange-100 border border-orange-300 rounded-full">
                                                        3
                                                    </span>
                                                ) : (
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                                ...
                                <p className="text-lg font-black text-secondary">
                                    {formatRupiah(
                                        selectedPegawai.total_realisasi,
                                    )}
                                </p>
                            </div>
                            <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                                ...
                                <p
                                    className={`text-lg font-black ${
                                        selectedPegawai.persentase >= 100
                                            ? "text-success"
                                            : "text-warning"
                                    }`}
                                >
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-4 py-2 text-xs font-medium text-right text-gray-500 uppercase">
                                            Nominal
                                        </th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {isLoading ? (
                                        ...
                                        <tr>
                                            <td
                                                colSpan="4"
                                                className="px-4 py-6 text-sm italic text-center text-gray-400"
                                            >
