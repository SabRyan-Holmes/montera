                                ...
                                <table className="table text-xs text-center table-bordered">
                                    <thead className="text-sm font-medium text-white bg-primary ">
                                        <tr className="text-center">
                                            ...
                                            {/* Header untuk Mapping Data target, kasi saran field apa aj yg ditampilin, kasi kodeny,  ga usa diubah desain css ny, fokus  mapping datanya aja */}
                                    ...
                                    <tbody>
                                        {targets.data?.map((target, i) => (
                                            <tr key={target.id}>
                                                ...
                                                {/* TODO:  */}
                                                {/*Tombol  Aksi tambahin tombol untuk tambah target untuk row ini, kasi react icon yg cocok, dan pake template action button gw kayak dibawah */}
                                                <td className="space-x-2 text-center whitespace-nowrap text-nowrap">
                                                    ...
                                                    {/* Tombol tambahan , ingat pake template kurang lebiuh sam kek ditas, tp pake raeact con dan text beda aj */}
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
