                ...
                <div className="navbar-end">
                    <div className="dropdown dropdown-end">
                        <label tabIndex={0} className="">
                            {!user ? (
                                <button className="mr-8 btn btn-ghost">Login / Register</button>
                            ) : (
                        ...
                        <ul tabIndex={0} className="mt-3 p-2 shadow menu menu-sm dropdown-content bg-white rounded-box w-52 z-[50] relative text-black">
                            <li><Link href="/dashboard">Dashboard</Link></li>
                            <li><Link href={route("profile.edit")}>Update Profil & Akun</Link></li>
