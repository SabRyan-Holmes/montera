...
export default function TooltipHover({message}) {
    return (
        <div
            className="absolute z-[999] w-fit px-3 py-1 mt-2 text-xs text-white transition-opacity duration-200
-translate-x-1/2 bg-accent rounded shadow-lg opacity-0 pointer-events-none left-1/2 top-full group-hover:opacity-100"
        >
            <small className="font-semibold">{message} </small>
